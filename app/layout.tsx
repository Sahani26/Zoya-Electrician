...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en-IN"><body id="top" className={`${sans.variable} ${serif.variable}`}>{children}</body></html>; }
